 ...
 * <p>
 * <b>Getting started.</b>
 * To use standard drawing, you must have {@code StdDraw.class} in your Java
 ...
 * main types of methods in standard drawing—methods that draw geometric shapes
 ...
 * {@link #PRINCETON_ORANGE}. For example,
 ...
 * You save your image to a file using the <em>File → Save</em> menu option. You
 * can also save a file programatically using the following method:
 * <ul>
 ...
 * inside the canvas if the
 * <em>x</em>- or <em>y</em>-coordinates are infinite. This bug appears only on
 * some systems.
 * </ul>
 * <p>
 * <b>Reference.</b>
